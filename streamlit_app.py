...
.block-container { padding: 1.15rem 1.0rem 1.2rem !important; max-width: 1180px; }
...
h1, h2, h3, h4, h5, h6, p, label, .stCaption, .stMetric, .stSelectbox label, .stMultiSelect label { text-align: right !important; }
...
.app-header {
  ...
  border-radius: 16px; padding: 26px 28px 18px;
  margin-top: 8px; margin-bottom: 0; position: relative; overflow: hidden;
}
.app-header::before {
...
.app-title { font-size: 24px; font-weight: 800; color: #f0f6ff; margin: 0; letter-spacing: -0.2px; line-height: 1.25; }
.app-sub   { font-size: 12px; color: #93b4e0; margin: 4px 0 0; line-height: 1.4; }
...
div[role="radiogroup"] label:has(input:checked) p, div[role="radiogroup"] label:has(input:checked) span { color:#ffffff !important; }
